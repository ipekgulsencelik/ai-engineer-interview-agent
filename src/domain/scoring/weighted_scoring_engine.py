...
class WeightedScoringEngine(ScoringEngine):
    ...
    SOLID notları:
        - SRP: Engine yalnızca orchestration yapar.
        - OCP: Yeni komponent eklemek için _build_score_components genişletilir.
        - DIP: Engine somut policy implementasyonuna değil policy arayüzüne
          benzer compute contract'larına bağımlı çalışır.
    """
