...
if TYPE_CHECKING:
    from src.application.benchmarking.models.benchmark_result import (
        BenchmarkResult,
    )
    
from src.application.benchmarking.schemas.benchmark_result_schema import (
    BENCHMARK_BOOLEAN_RULE,
    BENCHMARK_LATENCY_RULE,
    BENCHMARK_OPTIONAL_SCORE_RULE,
    BENCHMARK_OPTIONAL_STRING_RULE,
    BENCHMARK_RETRIEVED_COUNT_RULE,
    BENCHMARK_STRING_RULE,
)
    ...
    def _validate_optional_string(
        ...
        *,
        ...
        cls.validate_type(
            field_name=field_name,
            value=value,
            rules=BENCHMARK_OPTIONAL_STRING_RULE,
        )
    ...
    def _validate_retrieved_count(
        ...
        *,
        ...
        cls.validate_type(
            ...
            value=value,
            rules=BENCHMARK_RETRIEVED_COUNT_RULE,
        )
    ...
    def _validate_optional_score(
        ...
        *,
        ...
        cls.validate_type(
            field_name=field_name,
            value=value,
            rules=BENCHMARK_OPTIONAL_SCORE_RULE,
        )
