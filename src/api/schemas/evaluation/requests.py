...
class EvaluationRequest(BaseModel):
    ...
    Bu schema:
        - dış dünyadan gelen request payload'unu temsil eder
        - API contract boundary'sidir
        - domain entity değildir
    ...
    market_weight: PositiveFloat = DEFAULT_MARKET_WEIGHT
    ...
    def normalize_level(
        ...
        return EvaluationRequestValidator.normalize_level(
            value,
        )
    ...
    def normalize_difficulty(
        ...
        return EvaluationRequestValidator.normalize_difficulty(
            value,
        )
    ...
    def normalize_question_type(
        ...
        return EvaluationRequestValidator.normalize_question_type(
            value,
        )