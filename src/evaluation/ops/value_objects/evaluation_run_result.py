...
def __post_init__(
    ...
    EvaluationRunResultValidator.validate(
        ...
        quality_gate_result=(
            self.quality_gate_result
        ),
        ci_policy_result=(
            self.ci_policy_result
        ),
    ...
    def deployment_allowed(
        ...
        return (
            self.ci_policy_result.deployment_allowed
        )
    ...
    def has_blocking_failures(
        ...
        return (
            self.ci_policy_result.has_blocking_failures
        )

    @property
    def blocking_failure_count(
        self,
    ) -> int | None:
        if self.ci_policy_result is None:
            return None
